...
def make_year_plot(year, results_dict, num_variables=6, fig_size=9, alpha=0.5):
    """
...
def plot_risk(dict_extracted, baselines_extracted, random_extracted):
